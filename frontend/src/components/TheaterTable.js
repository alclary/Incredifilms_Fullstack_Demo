    ...
    <table className="table">
      ...
      <tbody>
        <tr>
          ...
          <td className="">300</td>
          <td className=""><a href="./TheaterUpdate" class="icons"><MdEdit/></a></td>
          <td className=""><a href="./TheaterConfirmDelete" class="icons"><MdDeleteForever/></a></td>
        </tr>
        <tr>
          <td className="">2</td>
          ...
          <td className="">500</td>
          <td className="" >
          <a href="./TheaterUpdate" class="icons"><MdEdit/></a>
          </td>
          <td className="">
          <a href="./TheaterConfirmDelete" class="icons"><MdDeleteForever/></a>
          </td>
        </tr>
        <tr>
          <td className="">3</td>
